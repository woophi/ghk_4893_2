...
export const App = () => {
  ...
  const submit = () => {
    window.gtag('event', '4893_accept_var2');
    setLoading(true);
  ...
  return (
    <>
      <div className={appSt.container}>
          ...
          <div className={appSt.boxRow2}>
            ...
            <div style={{ marginTop: '-40px' }}>
              ...
              <Typography.Text view="primary-small" color="secondary">
                ПДля новых денег, которые не были в накоплениях/активах последние 90 дней
              </Typography.Text>
            </div>
        ...
        <div>
          <div className={appSt.rowText} onClick={() => window.gtag('event', '4893_FAQ_var2')}>
            <CDNIcon name="glyph_question-circle_m" />
            <Typography.Text view="primary-medium">Частые вопросы</Typography.Text>
          </div>
          <div className={appSt.rowText} onClick={() => window.gtag('event', '4893_moreinfo_var2')}>
        ...
        <Typography.Text view="primary-small" color="secondary">
          ...
          <span style={{ textDecoration: 'underline' }} onClick={() => window.gtag('event', '4893_newinfo_var2')}>
